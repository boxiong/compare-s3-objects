package org.skygate.datasourcev2
...
object DataSourceV2Example {
  ...
  def main(args: Array[String]) {
    ...
    val simpleMultiDf = sparkSession.read
      .format("org.skygate.datasourcev2.simplemulti")
      .load()
    ...
    val simpleCsvDf = sparkSession.read
      .format("org.skygate.datasourcev2.simplecsv")
    ...
    val simpleMysqlDf = sparkSession.read
      .format("org.skygate.datasourcev2.simplemysql")
      .load()
    ...
    val simplePartitoningDf = sparkSession.read
      .format(
        "org.skygate.datasourcev2.partitionaffinity")
      .load()
